                ...
                <Card className="overflow-hidden shadow-xl">
                    <CardHeader className="bg-gray-100 p-8 md:flex-row flex-col flex items-start gap-8">
                        ...
                        <div className="flex flex-col space-y-2 w-full md:w-auto mt-4 md:mt-0">
                            <Button size="lg" className="w-full"><CalendarPlus className="mr-2 h-5 w-5" /> Book a Session</Button>
                            <Button size="lg" variant="outline" className="w-full"><MessageSquare className="mr-2 h-5 w-5" /> Send Message</Button>
                        </div>
                    </CardHeader>
